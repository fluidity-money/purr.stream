...
/// @notice Simple ERC20 + EIP-2612 implementation (MODIFIED TO REMOVE burn/hooks)
...
contract TestERC20 {
    ...
    function _constantNameHash() internal pure returns (bytes32 result) {
